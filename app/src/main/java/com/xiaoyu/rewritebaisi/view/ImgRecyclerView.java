package com.xiaoyu.rewritebaisi.view;
 ...
 * on 14-4-30.
 */
public class ImgRecyclerView extends ListView {
	...
	public ImgRecyclerView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		this.attrs = attrs;
		initView();
	...
	public ImgRecyclerView(Context context, AttributeSet attrs, int defStyle) {
