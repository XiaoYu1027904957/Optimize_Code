...
public class DetialTextActivity extends AppCompatActivity {
    ...
    class MyListadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(DetialTextActivity.this, R.layout.list_comment, null);
            ...
            Glide.with(mContext).load(listBeanX.getUser().getProfile_image()).transform(new GlideCircleTransform(DetialTextActivity.this)).into(holder.commentIcon);
