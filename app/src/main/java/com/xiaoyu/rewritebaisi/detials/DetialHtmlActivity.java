...
public class DetialHtmlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detial_html);
    ...
    class MyListadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(DetialHtmlActivity.this, R.layout.list_comment, null);
            ...
            Glide.with(mContext).load(listBeanX.getUser().getProfile_image()).transform(new GlideCircleTransform(DetialHtmlActivity.this)).into(holder.commentIcon);
