...
public class RecyclerDetialTextAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerDetialTextAdapter(Context mContext, List<DetialsBean.NormalBean.ListBeanX> datas, String image, String name, String time, String introduce, List<DetialsBean.HotBean.ListBean> hotlist) {
