...
public class PingLunFragment extends BaseFragment {
    ...
    @InjectView(R.id.recycler_pinglun)
    RecyclerView recyclerPinglun;
    private NotesAdapter adapter;
    List<TieZiBean.ListBean> list;
    public PingLunFragment(CommonBean.ListBean listBean) {
        this.listBean = listBean;
    }

    @Override
    protected View initView() {
        View view = View.inflate(mContext, R.layout.fragment_pinglun, null);
        ...
        GetNet.get(ContantUtils.PERSONAL_TIEZI_BASE + listBean.getU().getUid() + ContantUtils.PERSONAL_TIEZI_FOOT_URL, null, new OnGetListener() {
            ...
            public void onSuccess(String json) {
                ...
                if (json != null) {
                    ...
                    recyclerPinglun.setAdapter(adapter);
                    LinearLayoutManager manager = new LinearLayoutManager(mContext);
                    recyclerPinglun.setLayoutManager(manager);
                }
            }
